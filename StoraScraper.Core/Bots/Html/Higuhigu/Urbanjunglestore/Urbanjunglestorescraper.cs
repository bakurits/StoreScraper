...
namespace StoreScraper.Bots.Html.Higuhigu.Urbanjunglestore
{
    public class UrbanjunglestoreScraper : ScraperBase
    {
        ...
        private const string SearchFormat = @"https://www.urbanjunglestore.com/it/latest-products.html#page=12";
